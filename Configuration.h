...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  13.5754,  13.5754 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -60, -15, 0 } //measured by JLM
...
#define XY_PROBE_FEEDRATE (133*60)//#define Z_AFTER_PROBING           5 // Z position after probing is done
